...
public class StrategyVideo implements Parcelable {
    ...
    public StrategyVideo() {
    }

    protected StrategyVideo(Parcel in) {
    ...
    public static final Creator<StrategyVideo> CREATOR = new Creator<StrategyVideo>() {
        @Override
        public StrategyVideo createFromParcel(Parcel in) {
            return new StrategyVideo(in);
        }

        @Override
        public StrategyVideo[] newArray(int size) {
            return new StrategyVideo[size];
        }
    };
